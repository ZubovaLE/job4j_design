...
class MainTest {
    ...
    private static final Socks RED_SOCKS = new Socks(true, 89.9f, "red", new Contact("123-456"), "Socks", "made of cotton", "demi-season");
    ...
    private static Stream<Arguments> provideParametrizedTestArguments() {
        ...
        return Stream.of(
                ...
                Arguments.of(RED_SOCKS, expectedSocksJsonString)
        );
    }
